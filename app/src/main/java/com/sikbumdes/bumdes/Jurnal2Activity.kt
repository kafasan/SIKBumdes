...
import kotlinx.android.synthetic.main.activity_jurnal2.*
import kotlinx.android.synthetic.main.calendar_item.view.*
import java.util.*

class Jurnal2Activity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val cal = Calendar.getInstance()
        val datePos = cal.get(Calendar.DAY_OF_MONTH) - 1
        ...
        val singleRowCalendar = main_single_row_calendar.apply {
            ...
            initialPositionIndex = datePos
            init()
        }

        main_single_row_calendar.select(datePos)

        btnRight.setOnClickListener {
            singleRowCalendar.setDates(getDatesOfNextMonth())
            tvDate.text = "${DateUtils.getMonthName(calendar.time)}"
        }
