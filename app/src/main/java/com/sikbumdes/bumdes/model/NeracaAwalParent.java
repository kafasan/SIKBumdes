...
public class NeracaAwalParent {
    ...
    public NeracaAwalParent(int id, int id_business, int parent_code, String parent_name, ArrayList<NeracaAwalClass> neracaAwalClasses) {
        this.id = id;
    ...
    public ArrayList<NeracaAwalClass> getNeracaAwalClasses() {
        return neracaAwalClasses;
    }

    public void setNeracaAwalClasses(ArrayList<NeracaAwalClass> neracaAwalClasses) {
        this.neracaAwalClasses = neracaAwalClasses;
    }
}
